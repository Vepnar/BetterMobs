...
public class AuthorCommand implements CommandExecutor{
	...
	/**
	 * Handle the /bettermobs-author command.
	 * Will print information about the plugin parsed from plugin.yml
	 */
    @Override
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
    	...
    	final String messages[] = {javaplugin.prefix + " is made by §c" + pdf.getAuthors(),
                "§cSource: §fhttps://github.com/Vepnar/BetterMobs",
                "§cVersion: §f" + pdf.getVersion(),
