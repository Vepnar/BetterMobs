...
public class CreeperSpawnPotionEffects implements EventClass {
	...
	final PotionEffectType[] RAREEFFECTS = { PotionEffectType.LEVITATION, PotionEffectType.DOLPHINS_GRACE,
			PotionEffectType.GLOWING, PotionEffectType.LUCK, PotionEffectType.SATURATION, PotionEffectType.BAD_OMEN };
	...
	public String configName(Main m) {
		chance = m.getConfig().getInt("creeperSpawnPotionEffect.spawnChance");
		duration = m.getConfig().getInt("creeperSpawnPotionEffect.effectDuration") * 20;
	...
	public void callEvent(Event e) {
		...
		PotionEffect effect = new PotionEffect((PotionEffectType) effects[rand], duration, 0, false);
